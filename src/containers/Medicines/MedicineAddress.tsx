 ...
 {  addNewAddress &&  <View style={{borderTopWidth:1,borderTopColor:'#DAD9D9'}} >
 ...
 
       {
        addressData.map((item,index)=>{
          return(
            <View style={{paddingHorizontal:responsiveWidth(4),paddingVertical:responsiveHeight(2.4),backgroundColor: selectedAddress ===index ? '#FCE3D6':colors.white,gap:responsiveHeight(1.5),borderBottomWidth:responsiveWidth(0.5),borderBottomColor:'#DAD9D9'}} >
